...
const encryptedStream = async (media, mediaType, { logger, saveOriginalFileIfRequired, opts, newsletter } = {}) => {
    const { stream, type } = await (0, exports.getStream)(media, opts);
    const { stream: streams } = await (0, exports.getStream)(media, opts);
